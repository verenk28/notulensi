		...
		<form action="" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-3 col-sm-3 ">
              <input id="birthday" name="tanggal" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text"  type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" value="<?php echo $data['tanggal']; ?>" readonly>
              <script>
          ...
          <div class="col-md-3 col-sm-3">
          <input class="form-control" class='time' type="time" name="time" value="<?php echo $data['time']; ?>" readonly>
         </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="agenda" class="form-control" value="<?php echo $data['agenda']; ?>" readonly>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="tempat" class="form-control" value="<?php echo $data['tempat']; ?>" readonly>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="pimpinan" class="form-control" value="<?php echo $data['pimpinan']; ?>" readonly>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="text" name="notulis" class="form-control" value="<?php echo $data['notulis']; ?>"  readonly>
            </div> 
          </div>
          ...
          <div class="item form-group">
            <div class="col-md-3 col-sm-3 offset-md-3">
              <a href="template.php?f=lihatnotulen" class="btn btn-primary black">Kembali</a>
            </div>
          </div>
        </form>
          <ul class="nav navbar-right panel_toolbox">
          <li><div id="contact"><a href="notulen/cetak.php?id=<?php echo $_GET['id']?>" target="_blank" class="btn btn-primary black ">Print PDF</a>
           <!--  <button type="button" class="btn btn-info btn" data-toggle="modal" data-target="#contact-modal">Tambah Pembahasan</button></div></li> -->
          <?php
